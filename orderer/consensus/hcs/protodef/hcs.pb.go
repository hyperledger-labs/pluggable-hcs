...
type HcsConfigMetadata struct {
	...
	ReassembleTimeout    string   `protobuf:"bytes,3,opt,name=reassemble_timeout,json=reassembleTimeout,proto3" json:"reassemble_timeout,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *HcsConfigMetadata) GetReassembleTimeout() string {
	if m != nil {
...
var fileDescriptor_4a1dde7c60075de7 = []byte{
	...
	,
}
